...
# Change limit from 5000 to something larger, e.g., 50000
def load_rows(limit: int = 50000) -> pd.DataFrame: 
    ...
    # SORT IT: Ensure we see the newest data at the top
    # (Assumes you have a 'ts' or 'timestamp' column, or sort by ID descending)
    if "id" in df.columns:
